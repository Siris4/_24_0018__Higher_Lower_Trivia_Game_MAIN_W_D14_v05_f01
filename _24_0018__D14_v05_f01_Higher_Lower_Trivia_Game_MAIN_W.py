...
def game_on():
    ...
    while True:
        ...
        if hidden_profile_A_follower_count > hidden_profile_B_follower_count and a_or_b_profile_user_pick == "A":
            ...
            print(f"Sorry, but that is incorrect. {profile_name_A} has {hidden_profile_A_follower_count} million subscribers, and {profile_name_B} has {hidden_profile_B_follower_count} million subscribers.")
            counter = 0
            game_on = False
        ...
        if continue_next_part == "Y":
            ...
            print("OK then, good day to you too")
            return False
